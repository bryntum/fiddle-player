...
export default class TutorialPanel {
        ...
        return `
            <div class='code-wrap'>
                <div class="b-top-toolbar">
                    ...
                    <i class="b-fa b-fa-expand" data-reference="toggleFullscreen"></i>
                </div>
                ...
                <div class='b-code-toolbar' data-reference='toolbar' style="${this.hideToolbar ? 'display:none' : ''}">
                    <div class='run action' data-btip='Run code' data-action='run'>${this.runButtonTpl}</div>
    ...
    destroy() {
        ...
        me.toggleFullscreen.addEventListener('click', me.toggleFullscreen);
    }
    ...
    async onToolbarClick({ target }) {
        ...
        switch (actionNode.dataset.action) {
            ...
            case 'run':
                ...
                actionNode.innerHTML = this.runButtonTpl;
                break;
