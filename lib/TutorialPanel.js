...
export default class TutorialPanel {
    ...
    setLineVisible(lineIndex, visible) {
        [ this.lineElements, this.lineNumberContainer.children ]
            .map(lines => lines[lineIndex].classList)
            .forEach(classList => visible ? 
                classList.add('b-line-visible') : 
                classList.remove('b-line-visible'));
    }
