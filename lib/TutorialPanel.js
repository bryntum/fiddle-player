    ...
    async loadResources() {
        if (!this.resourcesLoaded && !this.loadingResources) {
            ...
            const
                ...
                stylesheet   = me.getAttribute('stylesheet') || (me.getAttribute('data-theme') === 'dark' && me.getAttribute('data-dark-stylesheet')) || me.getAttribute('data-light-stylesheet'),
